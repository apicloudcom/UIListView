...
public class SwipeMenuLayout extends FrameLayout {
	...
	public void updateSwipeMenuLayout(View contentView, SwipeMenuView menuView){
	...
	public void setForbiden(boolean isForbiden){
		this.forbiden = isForbiden;
	}
