...
public class SwipeMenuAdapter implements WrapperListAdapter, OnSwipeItemClickListener {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		 SwipeMenuLayout layout = null; //(SwipeMenuLayout)convertView;
...
//		if (layout == null) {
			...
			CustomListAdapter adapter = (CustomListAdapter) mAdapter;
			...
			if (itemDatas != null && itemDatas.size() > 0 && itemDatas.get(position) != null) {
				layout.setForbiden(itemDatas.get(position).forbidden);
			}
